            ...
            <div className='flex max-lg:ml-auto space-x-4'>
              {!user ? (
                ...
                <Link
                  ...
                  className='px-4 py-2 text-sm rounded-full font-bold text-gray-500 border-2 border-red-500 bg-red-500 hover:bg-gray-50 transition-all ease-in-out duration-300'
                >
                  Logout
                </Link>
              )}
