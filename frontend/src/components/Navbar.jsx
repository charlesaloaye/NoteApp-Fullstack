      ...
      <div className='flex flex-wrap items-center justify-between gap-5 w-full'>
        ...
        <div className='flex max-lg:ml-auto space-x-4'>
          {!user ? (
            ...
            <Link
              onClick={logout}
              className='px-4 py-2 text-sm rounded-full font-bold text-white border-2 border-red-500 bg-red-500 hover:bg-gray-50 transition-all ease-in-out duration-300'
            >
              Logout
            </Link>
          )}
